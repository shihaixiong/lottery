package com.maxsix.bingo.FlippingImageView;
...
public class FlippingImageView extends ImageView {
	...
	private com.maxsix.bingo.FlippingImageView.RotateAnimation mAnimation;
	...
	private void setRotateAnimation() {
		if (mIsHasAnimation == false && getWidth() > 0
			...
			mAnimation = new com.maxsix.bingo.FlippingImageView.RotateAnimation(getWidth() / 2.0F,
					getHeight() / 2.0F, com.maxsix.bingo.FlippingImageView.RotateAnimation.Mode.Y);
