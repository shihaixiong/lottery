...
public class EMobileTask {
    ...
    public static <T> void doAsync(final Context pContext, final int pTitleResID, final int pMessageResID, final Callable<T> pCallable, final com.maxsix.bingo.task.Callback<T> pCallback, final boolean pCancelable) {
        ...
        new AsyncTask<Void, Void, T>() {
            ...
            public void onPostExecute(final T result) {
                try {
                    ...
                    FLog.e("ERROR", Log.getStackTraceString(this.mException));
                }
                if (this.isCancelled()) {
        ...
        new AsyncTask<Void, Integer, T>() {
            ...
            public void onPostExecute(final T result) {
                try {
                    ...
                    FLog.e("ERROR", Log.getStackTraceString(e));
                    /* Nothing. */
                }
                if (this.isCancelled()) {
                    this.mException = new CancelledException();
