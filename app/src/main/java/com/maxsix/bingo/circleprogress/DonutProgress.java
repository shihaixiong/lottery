package com.maxsix.bingo.circleprogress;
...
public class DonutProgress extends View {
    ...
    public DonutProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = com.maxsix.bingo.circleprogress.Utils.sp2px(getResources(), 18);
        min_size = (int) com.maxsix.bingo.circleprogress.Utils.dp2px(getResources(), 100);
        default_stroke_width = com.maxsix.bingo.circleprogress.Utils.dp2px(getResources(), 10);
        default_inner_bottom_text_size = com.maxsix.bingo.circleprogress.Utils.sp2px(getResources(), 18);
