...
public class FragmentBettingList extends AppCompatActivity {
private int lid = -1;
    @Override
    ...
    public void back(View view) {
        if (lid == 1) {
            startActivity(new Intent(FragmentBettingList.this, MarxSixActivity.class));
        }else if (lid == 2) {
            startActivity(new Intent(FragmentBettingList.this, CqsscActivity.class));
        }else if (lid == 3) {
            startActivity(new Intent(FragmentBettingList.this, GdklcActivity.class));
        }else if (lid == 4) {
            startActivity(new Intent(FragmentBettingList.this, JSSBActivity.class));
        }else if (lid == 5) {
            startActivity(new Intent(FragmentBettingList.this, BJPKActivity.class));
        }
        finish();
    }
}
