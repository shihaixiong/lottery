...
public class MarxSixZXFragment extends BaseFragment implements View.OnClickListener{
    ...
    private int sumTZ = 0;
    private View rv;
    private String[] codevalues = {"Z-SX-SHU","Z-SX-NIU","Z-SX-HU","Z-SX-TU","Z-SX-LONG","Z-SX-SHE","Z-SX-MA","Z-SX-YANG","Z-SX-HOU","Z-SX-JI","Z-SX-GOU","Z-SX-ZHU"};
    private String[] names = {"鼠","牛","虎","兔","龙","蛇","马","羊","猴","鸡","狗","猪"};
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rv = inflater.inflate(
                R.layout.fragment_marxsixzx, container, false);
