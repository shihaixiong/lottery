...
public class MarxSixTXFragment extends BaseFragment implements View.OnClickListener{

    private LinearLayout[] bbbs= new LinearLayout[12];
    private int selectBtnIndex = 1;
    private Context context;
    private int[] bbbIds = new int[12];
    private TextView[] txts = new TextView[12];
    ...
    private int sumTZ = 0;
    private View rv;
    private String[] codevalues = {"T-SX-SHU","T-SX-NIU","T-SX-HU","T-SX-TU","T-SX-LONG","T-SX-SHE","T-SX-MA","T-SX-YANG","T-SX-HOU","T-SX-JI","T-SX-GOU","T-SX-ZHU"};
    private String[] names = {"特肖@鼠","特肖@牛","特肖@虎","特肖@兔","特肖@龙","特肖@蛇","特肖@马","特肖@羊","特肖@猴","特肖@鸡","特肖@狗","特肖@猪"};
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rv = inflater.inflate(
                R.layout.fragment_marxsixtx, container, false);
