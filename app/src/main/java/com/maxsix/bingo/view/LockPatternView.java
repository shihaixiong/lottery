package com.maxsix.bingo.view;

/**
 * Created by shihaixiong on 2017/4/7.
 */
...
public class LockPatternView extends View {
     ...
     * 保存选中点的集合
     */
    public List<PointView> mSelectedPointViewList;
     ...
     * 正常状态的颜色
     */
    private static final int NORMAL_COLOR = Color.parseColor("#00acff");
    /**
     * 选中状态的颜色
     */
    private static final int SELECTED_COLOR = Color.parseColor("#fb3c3c");
