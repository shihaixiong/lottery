package com.maxsix.bingo.dialog.TitleMenu;
...
public class TitlePopup extends PopupWindow {
	...
	// 定义弹窗子类项列表
	private ArrayList<com.maxsix.bingo.dialog.TitleMenu.ActionItem> mActionItems = new ArrayList<com.maxsix.bingo.dialog.TitleMenu.ActionItem>();
	...
	private void populateActions() {
		...
		mListView.setAdapter(new BaseAdapter() {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				TextView textView = com.maxsix.bingo.config.ViewHolder.get(convertView, R.id.txt_title);
				...
				com.maxsix.bingo.dialog.TitleMenu.ActionItem item = mActionItems.get(position);
	 ...
	 * 添加子类项
	 */
	public void addAction(com.maxsix.bingo.dialog.TitleMenu.ActionItem action) {
		if (action != null) {
	 ...
	 * 根据位置得到子类项
	 */
	public com.maxsix.bingo.dialog.TitleMenu.ActionItem getAction(int position) {
	...
	public static interface OnItemOnClickListener {
		public void onItemClick(com.maxsix.bingo.dialog.TitleMenu.ActionItem item, int position);
	}
}