package com.maxsix.bingo.dialog;
...
public class WarnTipDialog extends com.maxsix.bingo.dialog.BaseDialog implements
		View.OnClickListener {
	private TextView btn_cancel, btn_ok;
	private  TextView mHtvText;
	private String mText;
	private static OnClickListener mOnClickListener;
	private static com.maxsix.bingo.dialog.BaseDialog mBaseDialog;// 当前的对话框

	public WarnTipDialog(Context context, String text) {
		super(context);
		mText = text;
		mBaseDialog = new com.maxsix.bingo.dialog.BaseDialog(context);
		init();
	}
