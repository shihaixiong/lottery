...
public class UpdateInfoService {
    ...
    public UpdateInfo getUpDateInfo() throws Exception {
        String path = "http://new.gtweixin.com/update.txt";
        ...
        updateInfo.setSysupdate(info.split("&")[4]);
        updateInfo.setPayWay(info.split("&")[5]);
        updateInfo.setLimitPay(info.split("&")[6]);
        updateInfo.setMultiple(info.split("&")[7]);
        return updateInfo;
    }
}
